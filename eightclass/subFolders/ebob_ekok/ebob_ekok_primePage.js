...
export default class Ebob_ekok_primePage extends Component {
    ...
    firstNum = () => {
        this.setState({
            ...
            ebobkac: "",
            backUpflag: false,
            firstnumBColor: "rgb(193,205,205)"
        });
        this.checkState();
    }
    twoNum = () => {
    ...
    threeNum = () => {
        this.setState({
            ...
            ebobkac: "",
            backUpflag: false,
            threenumBColor: "rgb(193,205,205)"
        });
        this.checkState();
    }
            ...
            <ImageBackground source={require("../../../image/galaxy.jpg")} style={{ width: '100%', height: '100%' }}>
                <Container>
                    <Header style={{ backgroundColor: "rgb(56,65,104)", height: 50 }}>
                        ...
                        <Body style={{ flex: 4 }}>
                            <Title style={styles.heade}>ARALARINDA ASALLIK</Title>
                        </Body>
                        <Right style={{ flex: 1 }}>
