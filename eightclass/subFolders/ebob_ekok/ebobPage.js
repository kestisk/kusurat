...
export default class EbobPage extends Component {
    ...
    twoNum = () => {
        this.clean();
        this.setState({ iconname1: "check", iconname2: null, twonumBColor: "red", threenumBColor: "gray", backUpflag: false, showrightarray: [""], shownumber1: [""], shownumber2: [""], shownumber3: [""], que1: "1.Sayı", que2: "", que3: "", backColorT1: "green", backColorT2: "white", backColorT3: "white", returnebob: "yok", message: "", number1: [""], number2: [""], number3: [""], maxdoor: "2", doorstate: "Ikinci Sayiya Geç", door: "1", rightarray: [""], tempnumber1: "", tempnumber2: "", tempnumber3: "", });
    }
    threeNum = () => {
        this.clean();
        this.setState({ iconname2: "check", iconname1: null, twonumBColor: "gray", threenumBColor: "red", backUpflag: false, showrightarray: [""], shownumber1: [""], shownumber2: [""], shownumber3: [""], que1: "1.Sayı", que2: "", que3: "", backColorT1: "green", backColorT2: "white", backColorT3: "white", returnebob: "yok", message: "", number1: [""], number2: [""], number3: [""], maxdoor: "3", doorstate: "Ikinci Sayiya Geç", door: "1", rightarray: [""], tempnumber1: "", tempnumber2: "", tempnumber3: "", });
    }
    nextNum = () => {
    ...
    write = (param) => {
        ...
        if (clearctrl) {
            ...
            this.setState(() => ({ backUpflag: false, showrightarray: [""], shownumber1: [""], shownumber2: [""], shownumber3: [""], que1: "1.Sayı", que2: "", que3: "", backColorT1: "green", backColorT2: "white", backColorT3: "white", returnebob: "yok", message: "", number1: [""], number2: [""], number3: [""], doorstate: "Ikinci Sayiya Geç", door: "1", rightarray: [""], tempnumber1: "", tempnumber2: "", tempnumber3: "", }));
        }
        var doorctrl = this.state.door;
        var maxdoorctrl = this.state.maxdoor;
